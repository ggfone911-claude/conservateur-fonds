      ...
      <div style="overflow-x:auto;margin-top:10px">
        <table class="fund-table" style="width:100%">
          <thead><tr>
            ...
            <th colspan="5" style="text-align:right;padding-right:6px">
              <span style="display:inline-flex;gap:5px;align-items:center;flex-wrap:wrap;justify-content:flex-end">
